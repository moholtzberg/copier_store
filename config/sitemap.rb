...
SitemapGenerator::Sitemap.adapter = SitemapGenerator::S3Adapter.new({aws_access_key_id:     Spree::Config[:access_key_id],
                                                                    aws_secret_access_key: Spree::Config[:secret_access_key],
                                                                    fog_provider:          'AWS',
                                                                    fog_directory: Spree::Config[:bucket]})
